...
function setup() {
	...
	bob1=Bodies.circle(350,380,20,bob_opt);
	World.add(world,bob1);

	bob2=Bodies.circle(380,380,20,bob_opt);
	World.add(world,bob2);

	bob3=Bodies.circle(410,380,20,bob_opt);
	World.add(world,bob3);

	bob4=Bodies.circle(440,380,20,bob_opt);
	World.add(world,bob4);

	bob5=Bodies.circle(470,380,20,bob_opt);
